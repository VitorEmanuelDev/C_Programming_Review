/*
 ============================================================================
 Name        : array_13_c_for_win.c
 Author      : vitor emanuel
 Version     :
 Copyright   : 
 Description :  program to count total number of duplicate elements in an array.
 ============================================================================
 */
...
int main(void) {
	...
	for(int current = 0; current < newSize; current++){
		...
		if((frequencyArray[current] % 2 == 0) || (frequencyArray[current] > 2)){

			if((frequencyArray[current] > 2) && (frequencyArray[current] % 2 != 0))
				frequencyArray[current] -= 1;

			if(frequencyArray[current] >= 2)
				frequencyArray[current] /= 2;
